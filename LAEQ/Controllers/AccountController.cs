...
namespace LAEQ.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult DeleteUserRole(string Id,string Username)
        {
            using (var context = new IdentityDbContext())
            {

                var data = (from a in context.Users
                            where a.Id == Id
                            select new ViewUser
                            {
                                Id = a.Id,
                ...
                {
                    item.roleNames = UserManager.GetRoles(item.Id);
                }
        ...
        public List<IdentityRole> DataRole()
        {
            using (var context = new IdentityDbContext())
            {
                var roleStore = context.Roles.ToList();
                return roleStore.ToList();
            }
        }

        public List<ViewUser> DataUser()
        {
            using (var context = new IdentityDbContext())
            {
        ...
        public ActionResult AssignRole(string Id)
        {
            using (var context = new ApplicationDbContext())
            {
                var Role = from a in context.Users
                           where a.Id == Id
                           select new ViewUser
                           {
                               Id = a.Id,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AssignRole(ViewUser user)
        {
            using (var context = new ApplicationDbContext())
            {
                var userStore = new UserStore<ApplicationUser>(context);
